        ...
        <div class="card shadow-none border-0">
            <div class="card-header d-flex justify-content-between align-items-center"
                ...
                <div class="ml-auto">
                    ...
                    <a href="{{ route('contracts.create') }}" class="btn btn-default" title="Agregar contracto">
                        <span class="fas fa-plus" style="color: #69C5A0"></span>
                    </a>
                    <a href="{{ route('get.contracts') }}" class="btn btn-default" title="Actualizar contratos">
