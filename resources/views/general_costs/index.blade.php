    ...
    <div class="container-fluid">
        <div class="card shadow-none border-0">
            <div class="card-header d-flex justify-content-between align-items-center"
                ...
                <h3 class="card-title m-0" style="color: #69C5A0; font-size: 25px;"><strong>Costos generales</strong></h3>
                ...
                <form action="{{ route('general_costs.index') }}" method="GET"
                    ...
                    <div class="form-group mb-3 mt-2">
                        ...
                        <select id="perPageSelect" name="per_page" class="form-select" style="border-radius: 20px"
                            ...
                            <option value="10" {{ $generalCosts->perPage() == 10 ? 'selected' : '' }}>10</option>
                            <option value="25" {{ $generalCosts->perPage() == 25 ? 'selected' : '' }}>25</option>
                            <option value="50" {{ $generalCosts->perPage() == 50 ? 'selected' : '' }}>50</option>
                            <option value="100" {{ $generalCosts->perPage() == 100 ? 'selected' : '' }}>100</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group mb-0">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="search" placeholder="Buscar costo"
