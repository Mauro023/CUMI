    ...
    <div class="container-fluid">
        <div class="card shadow-none border-0">
            <div class="card-header d-flex justify-content-between align-items-center"
                ...
                <h3 class="card-title m-0" style="color: #69C5A0; font-size: 25px;"><strong>Equipos alquilados</strong></h3>
                <div class="ml-auto d-flex align-items-center gap-2">
                    @can('create_employes')
                    <a href="{{ route('rentedEquipments.create') }}" class="btn btn-default" title="Agregar empleado">
            ...
            <div class="card-body p-0">
                <form action="{{ route('rentedEquipments.index') }}" method="GET"
                ...
                <div class="card-panel">
                    @include('rented_equipments.table')
                </div>
            </div>
        </div>
    </div>
