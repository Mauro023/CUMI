    ...
    <div class="container-fluid">
        <div class="card shadow-none border-0">
            <div class="card-header d-flex justify-content-between align-items-center"
                style="padding: 0 0;">
                <h3 class="card-title m-0" style="color: #69C5A0; font-size: 25px;"><strong>Costos x procedimientos</strong></h3>
            </div>
            <div class="card-body p-0">
                <form action="{{ route('logOperationCosts.index') }}" method="GET"
                ...
                <div class="card-panel">
                    @include('log_operation_costs.table')
                </div>
            </div>
        </div>
    </div>
